...
const TITLES_BY_CATEGORY: Record<Category, string[]> = {
  EDU: [
    ...
    'Tech Digest Presentation A',
    'Tech Digest Presentation B',
    'Tech Digest Presentation C',
    'Internal Workshop: Productivity Tools',
    'Internal Workshop: Dev Practices',
    'Team Learning Day: Topic A',
    'Team Learning Day: Topic B',
    'Brown Bag Lunch Talk',
  ],
  PEG: [
    'External Conference Talk #1',
    'External Conference Talk #2',
    'Meetup Presentation #1',
    'Meetup Presentation #2',
  ],
  LAB: [
    'Lab Session: Group A',
    'Lab Session: Group B',
  ...
  UNI: [
    'University Guest Lecture #1',
    'University Guest Lecture #2',
    'Academic Collaboration Meeting',
